...
ggplot(subset(annotations_per_ORF_Type, Annotation_present==TRUE), aes(Database,Count)) + geom_bar(stat="identity",  aes(fill=ORF_Type)) + theme_bw() + labs(fill="Transdecoder ORF Type") + theme(axis.text.x=element_text(angle=45, vjust=0.9, hjust=1))
```
