...
<label class="control-label" for="length">Select the max. length to display:</label>
<div>
<select id="length"><option value="1000">1000</option>
<option value="5000">5000</option>
<option value="10000" selected>10000</option>
<option value="20000">20000</option></select>
<script type="application/json" data-for="length" data-nonempty="">{}</script>
</div>
</div><!--/html_preserve--><!--html_preserve--><div id="out6e45af42c110f6ca" class="shiny-plot-output" style="width: 100% ; height: 400px"></div><!--/html_preserve-->
