...
par(mfrow = c(2,1), oma=c(4,4,2,0.5))
heatmap.2(as.matrix(CBAS_DeSeq_Transdecoded_Only_distances), trace="none", labRow=FALSE, dendrogram=c("column"), col=rev(colorRampPalette(brewer.pal(9, "GnBu"))(100)))
