...
output:
  ...
  md_document: default
---
```{r load_libraries_and_set_globals, include=FALSE}
library(knitr)
library(ggplot2)
library(reshape2)
library("geneplotter")
...
#change this value to get results for transcripts above the desired_LFC_threshold
#note that the GO-term and Pfam enrichment analyses were done only with desired_LFC_threshold=1 and desired_LFC_threshold=2
desired_LFC_threshold<-1

#should the script write the output or not?
write_degs_output<-FALSE
write_background_output<-FALSE
...
meta_annotations<-read.table("~/Repos/CBAS/CBAS_DE/Annotations/Metatable/20161123_CBAS_Annotation_Metatable.csv.gz", head=T, sep="\t", quote="", comment.char="")

#histogram table
transcript_lengths<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Reference_transcriptome_length_histogram.csv", head=T, sep="\t")

#load tpm and fpkm matrices
tpm_matrix<-read.csv("~/Repos/CBAS/CBAS_DE/Counts/CBAS_Bleaching_RSEM_Expression_TPM_Matrix.csv", sep="\t", header=TRUE)
fpkm_matrix<-read.csv("~/Repos/CBAS/CBAS_DE/Counts/CBAS_Bleaching_RSEM_Expression_FPKM_Matrix.csv", sep="\t", header=TRUE)
...
CBAS_DE<-read.csv("~/Repos/CBAS/CBAS_DE/Counts/CBAS_Bleaching_RSEM_Expression_Matrix.counts", head=T, sep="\t")
CBAS_DE_INFO<-read.csv("~/Repos/CBAS/CBAS_DE/Counts/CBAS_Bleaching_RSEM_Expression_Matrix.info", head=T)
...
#number of overexpressed genes at 0.01 significance level and log fold change >= desired_LFC_threshold; see above
CBAS_DE_Genes_Over<-table(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results$padj < 0.01 & CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results$log2FoldChange >= desired_LFC_threshold)

#number of underexpressed genes at 0.01 significance level and log fold change =< -(desired_LFC_threshold); see above
CBAS_DE_Genes_Under<-table(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results$padj < 0.01 & CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results$log2FoldChange <= -(desired_LFC_threshold))
...
degs_table<-subset(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results, padj<0.01 & abs(log2FoldChange) >= desired_LFC_threshold)
degs_names<-rownames(degs_table)

#get significantly overexpressed in treatment:
over_deg_table<-subset(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results, padj<0.01 & log2FoldChange >= desired_LFC_threshold)
over_deg_names<-rownames(over_deg_table)

#get significantly underexpressed in treatment:
under_deg_table<-subset(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results, padj<0.01 & log2FoldChange <= -(desired_LFC_threshold))
under_deg_names<-rownames(under_deg_table)

if(write_degs_output){#yes, I know this code sucks...
  
  if(desired_LFC_threshold == 1){
    #write all degs  
    write.csv(degs_table, "~/Repos/CBAS/CBAS_DE/Results/DEGs/all_degs_p001_1LFC_all_info.csv")
    write.csv(degs_names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/all_degs_p001_1LFC_names_only.csv")
    
    #write over degs
    write.csv(over_deg_table, "~/Repos/CBAS/CBAS_DE/Results/DEGs/over_degs_p001_1LFC_all_info.csv")
    write.csv(over_deg_names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/over_degs_p001_1LFC_names_only.csv")
    
    #write under degs
    write.csv(under_deg_table, "~/Repos/CBAS/CBAS_DE/Results/DEGs/under_degs_p001_1LFC_all_info.csv")
    write.csv(under_deg_names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/under_degs_p001_1LFC_names_only.csv")
    
    
  }else if(desired_LFC_threshold == 2){
    #write all degs  
    write.csv(degs_table, "~/Repos/CBAS/CBAS_DE/Results/DEGs/all_degs_p001_2LFC_all_info.csv")
    write.csv(degs_names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/all_degs_p001_2LFC_names_only.csv")
  
    #write over degs
    write.csv(over_deg_table, "~/Repos/CBAS/CBAS_DE/Results/DEGs/over_degs_p001_2LFC_all_info.csv")
    write.csv(over_deg_names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/over_degs_p001_2LFC_names_only.csv")

    #write under degs
    write.csv(under_deg_table, "~/Repos/CBAS/CBAS_DE/Results/DEGs/under_degs_p001_2LFC_all_info.csv")
    write.csv(under_deg_names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/under_degs_p001_2LFC_names_only.csv")

  }else{
    
    print("please define an output file... For this you need to modify the code, sorry!")
...
plotMA(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results, alpha=0.01, ylim=c(-9.5,9.5))
...
if(write_background_output){

  if(desired_LFC_threshold == 1){
    
    write.csv(GO_Background_Gene_Names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/Back_degs_p001_1LFC.csv")
    write.csv(GO_Over_Background_Gene_Names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/Back_over_degs_p001_1LFC.csv")
    write.csv(GO_Under_Background_Gene_Names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/Back_under_degs_p001_1LFC.csv")
    
  }else if(desired_LFC_threshold == 2){
    
    write.csv(GO_Background_Gene_Names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/Back_degs_p001_2LFC.csv")
    write.csv(GO_Over_Background_Gene_Names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/Back_over_degs_p001_2LFC.csv")
    write.csv(GO_Under_Background_Gene_Names, "~/Repos/CBAS/CBAS_DE/Results/DEGs/Back_under_degs_p001_2LFC.csv")
    
  }else{
    
    print("You need to provide an output file, for this you have to modify the code. Sorry!")
...
if(desired_LFC_threshold == 1){
  ...
  overdegs_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/over_degs_p001_1LFC_names_only.functions.gos")
  overback_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_over_degs_p001_1LFC.functions.gos")
  #process GO analysis
  overdegs_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/over_degs_p001_1LFC_names_only.processes.gos")
  overback_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_over_degs_p001_1LFC.processes.gos")
  #component GO analysis
  overdegs_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/over_degs_p001_1LFC_names_only.components.gos")
  overback_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_over_degs_p001_1LFC.components.gos")

  
}else if(desired_LFC_threshold == 2){
  #function GO analysis
  overdegs_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/over_degs_p001_2LFC.functions.gos")
  overback_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_over_degs_p001_2LFC.functions.gos")
  #process GO analysis
  overdegs_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/over_degs_p001_2LFC.processes.gos")
  overback_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_over_degs_p001_2LFC.processes.gos")
  #component GO analysis
  overdegs_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/over_degs_p001_2LFC.components.gos")
  overback_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_over_degs_p001_2LFC.components.gos") 
  
}else {
  
  print("The LFC you are using was not analyzed in the original dataset. You need to generate the go term list for the set of transcripts you generated previously.")
...
over_functions_go_data<-new("topGOdata", ontology="MF", allGenes=over_genes_of_interest_list_for_function, annot=annFUN.gene2GO, gene2GO=over_universe_for_function_topgo, nodeSize=10)
...
over_process_go_data<-new("topGOdata", ontology="BP", allGenes=over_genes_of_interest_list_for_process, annot=annFUN.gene2GO, gene2GO=over_universe_for_process_topgo, nodeSize=10)
...
over_component_go_data<-new("topGOdata", ontology="CC", allGenes=over_genes_of_interest_list_for_component, annot=annFUN.gene2GO, gene2GO=over_universe_for_component_topgo, nodeSize=10)
...
#generate table of results
#over_functions_go_table<-GenTable(over_functions_go_data, classic=over_resultsFisher_functions, topNodes=1575)
over_functions_go_table<-GenTable(over_functions_go_data, classic=over_resultsFisher_functions, topNodes=50)
kable(subset(over_functions_go_table,classic < 0.05))
```
...
#generate table of results
#over_process_go_table<-GenTable(over_process_go_data, classic=over_resultsFisher_process, topNodes=7271)
over_process_go_table<-GenTable(over_process_go_data, classic=over_resultsFisher_process, topNodes=50)
kable(subset(over_process_go_table,classic < 0.05))
```
...
#generate table of results
#over_component_go_table<-GenTable(over_component_go_data, classic=over_resultsFisher_component, topNodes=959)
over_component_go_table<-GenTable(over_component_go_data, classic=over_resultsFisher_component, topNodes=50)
kable(subset(over_component_go_table, classic < 0.05))
```
...
if(desired_LFC_threshold == 1){
  #function GO analysis
  underdegs_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/under_degs_p001_1LFC_names_only.functions.gos")
  underback_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_under_degs_p001_1LFC.functions.gos")

  #process GO analysis
  underdegs_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/under_degs_p001_1LFC_names_only.processes.gos")
  underback_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_under_degs_p001_1LFC.processes.gos")
  
  #component GO analysis
  underdegs_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/under_degs_p001_1LFC_names_only.components.gos")
  underback_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_under_degs_p001_1LFC.components.gos")

}else if(desired_LFC_threshold == 2){
  
  #function GO analysis
  underdegs_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/under_degs_p001_2LFC.functions.gos")
  underback_Function_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_under_degs_p001_2LFC.functions.gos")
  
  #process GO analysis
  underdegs_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/under_degs_p001_2LFC.processes.gos")
  underback_Process_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_under_degs_p001_2LFC.processes.gos")
  
  #component GO analysis
  underdegs_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/under_degs_p001_2LFC.components.gos")
  underback_Component_GO<-readMappings("~/Repos/CBAS/CBAS_DE/Results/GOs/Back_under_degs_p001_2LFC.components.gos") 
...
under_functions_go_data<-new("topGOdata", ontology="MF", allGenes=under_genes_of_interest_list_for_function, annot=annFUN.gene2GO, gene2GO=under_universe_for_function_topgo, nodeSize=10)
...
under_process_go_data<-new("topGOdata", ontology="BP", allGenes=under_genes_of_interest_list_for_process, annot=annFUN.gene2GO, gene2GO=under_universe_for_process_topgo, nodeSize=10)
...
under_component_go_data<-new("topGOdata", ontology="CC", allGenes=under_genes_of_interest_list_for_component, annot=annFUN.gene2GO, gene2GO=under_universe_for_component_topgo, nodeSize=10)
...
#under_functions_go_table<-GenTable(under_functions_go_data, classic=under_resultsFisher_functions, topNodes=1575)
under_functions_go_table<-GenTable(under_functions_go_data, classic=under_resultsFisher_functions, topNodes=50)
kable(subset(under_functions_go_table, classic < 0.05))
```
...
#under_process_go_table<-GenTable(under_process_go_data, classic=under_resultsFisher_process, topNodes=7271)
under_process_go_table<-GenTable(under_process_go_data, classic=under_resultsFisher_process, topNodes=50)
kable(subset(under_process_go_table, classic < 0.05))
```
...
#under_component_go_table<-GenTable(under_component_go_data, classic=under_resultsFisher_component, topNodes=959)
under_component_go_table<-GenTable(under_component_go_data, classic=under_resultsFisher_component, topNodes=50)
kable(subset(under_component_go_table, classic < 0.05))
```
...
if(desired_LFC_threshold == 1){
  ...
  over_degs_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/over_degs_p001_1LFC.pfam", sep="\t", head=F)
  over_back_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/Back_over_degs_p001_1LFC.pfam", sep = "\t", head=F)
  over_domains<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/over_degs_p001_1LFC.pfam.list", sep="\t", head=F)

}else if(desired_LFC_threshold == 2){
  over_degs_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/over_degs_p001_2LFC.pfam", sep="\t", head=F)
  over_back_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/Back_over_degs_p001_2LFC.pfam", sep = "\t", head=F) 
  over_domains<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/over_degs_p001_2LFC.pfam.list", sep="\t", head=F)
  
}else{
  
  print("The LFC you are using was not analyzed in the original dataset. You need to generate the pfam list for the set of transcripts you generated previously.")
...
if(desired_LFC_threshold == 1){
  ...
  under_degs_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/under_degs_p001_1LFC.pfam", sep="\t", head=F)
  under_back_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/Back_under_degs_p001_1LFC.pfam", sep = "\t", head=F)  
  under_domains<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/under_degs_p001_1LFC.pfam.list", sep="\t", head=F)
}else if(desired_LFC_threshold == 2){
  
  under_degs_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/under_degs_p001_2LFC.pfam", sep="\t", head=F)
  under_back_pfam<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/Back_under_degs_p001_2LFC.pfam", sep = "\t", head=F)
  under_domains<-read.csv("~/Repos/CBAS/CBAS_DE/Results/Pfam/under_degs_p001_2LFC.pfam.list", sep="\t", head=F)
}else{
