...
In this reduced dataset, a total of 5466 transcripts were differentially expressed between the *control* and *bleached* sponges (Fig. 11). Of these transcripts, 402 were overexpressed (with a log2 fold change higher or equal to 2) in *bleached vs. control* sponges and 1585 were expressed at lower levels (a log2 fold change lower or equal than -2) in *bleached vs. control* specimens.
