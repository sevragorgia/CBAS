...
```{r GO_Function_analysis, include=FALSE, results='hide'}

#for this step you need to run the script Get_DEG_GO_Annotation.pl, which will take a list of transcripts and will return a TopGO ready file for the following analyses
#using the background and degs and the GO annotations for the transcripts in the universe use topGO to assess enrichment

#function GO analysis
alldegs_Function_GO<-readMappings("../Results/GOs/all_degs_p001_2LFC.functions.gos")
allback_Function_GO<-readMappings("../Results/GOs/Back_degs_p001_2LFC.functions.gos")

universe_for_function_topgo<-c(alldegs_Function_GO, allback_Function_GO)

#get names of genes in different groups
genes_of_interest_for_function<-names(alldegs_Function_GO)
genes_in_background_for_function<-names(allback_Function_GO)
