...
ui<-bootstrapPage(
  selectInput("length", "Select the max. length to display:", c(1000,5000,10000,20000), selected= 20000),
...
server <- function(input,output) {
  ...
  selected_transcript_lengths<-subset(transcript_lengths, transcript_lengths$Length<input$length)
