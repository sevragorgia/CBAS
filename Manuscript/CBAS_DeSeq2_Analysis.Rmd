...
```
**Figure 3.** Annotation success by database for transcripts translated by Transdecoder.
...
```
**Figure 4.** Annotation count by database for different types of ORF as defined by Transdecoder.
...
Internal | Uniprot | $`r as.vector(tapply(meta_annotations$evalue, meta_annotations$ORF_Type, mean, na.rm=TRUE))[3]`$ ($`r as.vector(tapply(meta_annotations$evalue, meta_annotations$ORF_Type, sd, na.rm=TRUE))[3]`$)
Complete | Uniprot | $`r as.vector(tapply(meta_annotations$evalue, meta_annotations$ORF_Type, mean, na.rm=TRUE))[4]`$ ($`r as.vector(tapply(meta_annotations$evalue, meta_annotations$ORF_Type, sd, na.rm=TRUE))[4]`$)
