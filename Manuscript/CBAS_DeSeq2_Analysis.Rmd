...
#merge(CBAS_DeSeq_Transdecoded_Only_NoOutliers_log2Counts_Over,CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results[rownames(CBAS_DeSeq_Transdecoded_Only_NoOutliers_Results) %in% over_deg_names, ], by="row.names", all=T)
#heatmap.2(log2(counts(CBAS_DeSeq_Transdecoded_Only_NoOutliers, normalized=T)[rownames(CBAS_DeSeq_Transdecoded_Only_NoOutliers) %in% over_deg_names, ]+1), scale="row", trace = "none", dendrogram = "column", col= colorRampPalette(rev(brewer.pal(9, "RdBu"))))
